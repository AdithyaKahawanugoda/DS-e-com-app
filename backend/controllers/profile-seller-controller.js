...
exports.getSellerProducts = async(req,res) =>{
    ...
    await ProductModel.find({sellerID:sellerID})
    .exec((error,products)=>{
        if(error){
...
exports.createSellerProduct = async(req,res) =>{
    const { productName, category, productDetails,unitPrice,discountPercentage, quantity, productImgEnc } = req.body;
...
exports.updateSellerDetails = async(req,res) =>{
    ...
    const { username, email, password,  paymentOptions, address, phone} = req.body;
